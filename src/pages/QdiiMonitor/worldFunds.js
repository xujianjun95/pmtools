...
export const WORLD_COUNTRIES = [
  ...
  },
  {
    ...
    funds: [
      ...
      { code: '012979', name: '大成恒生科技ETF发起式联接A', kind: '被动联接', track_target: '恒生科技指数', status: '开放申购', limit_amount: 100000000000, tracking_error: 2.21, fee: 0.12, y1: -31.77, return_1m: -8.24, return_6m: -16.71, return_1y: -31.77, return_3y: -3.69, return_since: -31.41, inception_date: '2021-09-09', fund_size: 22.93, fund_size_date: '2026-06-30', management_fee_rate: 0.5, custody_fee_rate: 0.1 },
      { code: '012980', name: '大成恒生科技ETF发起式联接C', kind: '被动联接', track_target: '恒生科技指数', status: '开放申购', limit_amount: 100000000000, tracking_error: 2.2, fee: 0, y1: -32.04, return_1m: -8.28, return_6m: -16.87, return_1y: -32.04, return_3y: -4.53, return_since: -32.55, inception_date: '2021-09-09', fund_size: 18.14, fund_size_date: '2026-06-30', management_fee_rate: 0.5, custody_fee_rate: 0.1 },
      ...
      { code: '022005', name: '广发恒生科技ETF联接F', kind: '被动联接', track_target: '恒生科技指数', status: '开放申购', limit_amount: 100000000000, tracking_error: 1.89, fee: 0, y1: -32.08, return_1m: -8.24, return_6m: -16.74, return_1y: -32.08, return_3y: null, return_since: 13.24, inception_date: '2024-09-04', fund_size: 2.38, fund_size_date: '2026-06-30', management_fee_rate: 0.5, custody_fee_rate: 0.1 },
