...
import { WORLD_COUNTRIES, countryById } from '../worldFunds'
import { fmtLimit } from '../utils'
import styles from './HeroSection.module.css'

// 首屏主角：本页监控纳指 100 / 标普 500 → 美国
const FOCUS_ID = '840'
...
const LABELS = Object.fromEntries(
  WORLD_COUNTRIES.map((c) => [c.id, `${c.zh}，${c.funds.length} 只基金，进入该国市场`])
)
...
// 换成该国摘要。底部固定一行，左侧信息、右侧常驻「查看全部市场」，因此不依赖 hover
